...
fetchData() {
            ...
            handleChange(e){
             ...
             if(this.state.usernameError===false && this.state.nationalityError===false && 
              this.state.emailError===false && this.state.passwordError===false && this.state.phoneError==false){
                this.setState({
                  isDisabled:false
                })
             }
    ...
    render() {
        ...
        return (
            <>
              ...
              <div className="form-group">
                <div className="form-label-group">
                  <input type="text2" id="phone" name="phone"required className="form-control" placeholder="Phone Number" onChange={(e)=>{this.handleChange(e)}} />
                  <label htmlFor="phone"></label>
                  {this.state.phoneError ? <span style={{color: "orangered"}}>Enter Valid Phone Number ex :20-XX-XXX-XXXX </span> : ''}
                </div>
              </div>
            
                  <div className="form-group">
                <div className="form-label-group">
                  <input type="nationality" id="nationality" name="nationality" required className="form-control" placeholder="Nationality" onChange={(e)=>{this.handleChange(e)}} />
                  <label htmlFor="nationality"></label>
                  {this.state.nationalityError ? <span style={{color: "orangered"}}>Please Enter some value</span> : ''}
                </div>
              </div>
                ...
                {this.renderRedirect()}
                {this.submitForm}
                 <input type="submit" value="Sign up" onClick={() => this.fetchData()}  disabled={this.state.isDisabled} />
                </div>
